...
serve(async (req) => {
  ...
  try {
    ...
    if (hasActiveSub) {
      ...
      let credits = 3; // Basic
      if (plan === "pro") credits = 999999; // Unlimited
      if (plan === "enterprise") credits = 999999; // Unlimited
      ...
      logStep("Profile updated", { plan, subscriptionEnd });
    } else {
