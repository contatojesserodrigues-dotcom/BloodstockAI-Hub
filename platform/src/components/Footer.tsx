...
import logoFooter from "@/assets/bloodstockai-logo-footer.png";
      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="mb-6 grid grid-cols-1 gap-8 sm:mb-8 sm:grid-cols-2 md:grid-cols-4 md:gap-8">
          <div className="col-span-1 flex flex-col items-center md:items-start gap-4">
            <Link to="/" className="inline-block">
              <img
                src={logoFooter}
                alt="BloodstockAI — AI Powered Bloodstock Analytics"
                className="h-16 sm:h-[72px] w-auto max-w-[260px] object-contain object-left"
              />
            </Link>
          </div>
        ...
        <div className="pt-6 sm:pt-8 flex flex-col md:flex-row justify-between items-center gap-3">
          <p className="text-[10px] sm:text-xs text-white/50 text-center md:text-left">
            © 2026 BloodstockAI® Ltd. All rights reserved.
          </p>
