...
const metricCards = [
  { label: "Horses Analysed", value: "248", change: "+18 this week" },
  { label: "High Potential Lots", value: "34", change: "12 recommended" },
  { label: "Market Opportunities", value: "19", change: "6 new today" },
  { label: "Inspection Reports", value: "41", change: "5 pending" },
  { label: "Client ROI", value: "+24%", change: "vs. last sale" },
  { label: "Active Sales", value: "8", change: "3 this month" },
];

const tableRows = [
  { lot: "89", horse: "Bay Colt", sire: "Dubawi", sale: "Tattersalls", score: "9.3", risk: "Low", value: "£205k", status: "recommended" as const },
  { lot: "142", horse: "Chestnut Filly", sire: "Galileo", sale: "Goffs", score: "8.7", risk: "Low", value: "€245k", status: "highValue" as const },
  { lot: "456", horse: "Dark Bay Colt", sire: "Into Mischief", sale: "Keeneland", score: "9.1", risk: "Med", value: "$385k", status: "roi" as const },
  { lot: "56", horse: "Gray Colt", sire: "Constitution", sale: "OBS", score: "8.4", risk: "Med", value: "$195k", status: "watchlist" as const },
  { lot: "201", horse: "Bay Filly", sire: "I Am Invincible", sale: "Magic Millions", score: "8.9", risk: "High", value: "A$355k", status: "risk" as const },
];
...
const statusBadge = (status: (typeof tableRows)[0]["status"]) => {
  const map = {
          ...
          <div className="grid lg:grid-cols-5 gap-3">
            ...
            <div className="lg:col-span-2 flex flex-col gap-3">
              ...
              <div className="rounded-xl border border-amber-200/60 bg-amber-50/50 px-3 py-2.5 flex gap-2">
                ...
                <div>
                  <p className="text-[10px] font-medium text-amber-900">Risk Alert — Lot 201</p>
                  <p className="text-[9px] text-amber-800/70">Conformation note flagged · Inspection pending</p>
                </div>
              </div>
            </div>
          </div>
