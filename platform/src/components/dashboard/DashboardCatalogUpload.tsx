...
import { configurePdfjs, pdfjsLib } from "@/lib/configurePdfjs";
...
export function DashboardCatalogUpload() {
        ...
        <PremiumCard variant="elevated">
          <div className="p-4 sm:p-5">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h2 className="text-base font-semibold tracking-[-0.02em] text-foreground">Upload Catalog</h2>
            </div>
            <p className="text-xs text-muted-foreground mb-4">
              Drop a full auction catalogue PDF for AI lot-by-lot analysis
            </p>
            <div
