  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-bs-bg">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(37,99,235,0.14),transparent_50%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,rgba(59,130,246,0.1),transparent_45%)]" />
      </div>
